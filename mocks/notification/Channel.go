...
func (_m *Channel) Send(notifiable interface{}, _a1 notification.Notification) error {
...
func (_c *Channel_Send_Call) Run(run func(notifiable interface{}, _a1 notification.Notification)) *Channel_Send_Call {
...
func (_c *Channel_Send_Call) RunAndReturn(run func(interface{}, notification.Notification) error) *Channel_Send_Call {
	_c.Call.Return(run)
	return _c
}
