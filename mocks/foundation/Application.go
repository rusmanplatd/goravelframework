...
import (
	auth "github.com/rusmanplatd/goravelframework/contracts/auth"
	access "github.com/rusmanplatd/goravelframework/contracts/auth/access"
	...
	config "github.com/rusmanplatd/goravelframework/contracts/config"

	console "github.com/rusmanplatd/goravelframework/contracts/console"

	context "context"

	crypt "github.com/rusmanplatd/goravelframework/contracts/crypt"
	...
	grpc "github.com/rusmanplatd/goravelframework/contracts/grpc"

	hash "github.com/rusmanplatd/goravelframework/contracts/hash"
	...
	queue "github.com/rusmanplatd/goravelframework/contracts/queue"
	...
	seeder "github.com/rusmanplatd/goravelframework/contracts/database/seeder"
	...
	validation "github.com/rusmanplatd/goravelframework/contracts/validation"

	view "github.com/rusmanplatd/goravelframework/contracts/view"
)
...
func (_m *Application) MakeBroadcast() broadcast.Manager {
	ret := _m.Called()
...
func (_c *Application_MakeBroadcast_Call) Return(_a0 broadcast.Manager) *Application_MakeBroadcast_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Application_MakeBroadcast_Call) RunAndReturn(run func() broadcast.Manager) *Application_MakeBroadcast_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Application) MakeNotification() notification.Factory {
	ret := _m.Called()
	...
	var r0 notification.Factory
	if rf, ok := ret.Get(0).(func() notification.Factory); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(notification.Factory)
		}
	}
...
func (_c *Application_MakeNotification_Call) Return(_a0 notification.Factory) *Application_MakeNotification_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Application_MakeNotification_Call) RunAndReturn(run func() notification.Factory) *Application_MakeNotification_Call {
	_c.Call.Return(run)
	return _c
}
...
// MakePipeline provides a mock function with no fields
func (_m *Application) MakePipeline() pipeline.Pipeline {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for MakePipeline")
	}

	var r0 pipeline.Pipeline
	if rf, ok := ret.Get(0).(func() pipeline.Pipeline); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
// Application_MakePipeline_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MakePipeline'
type Application_MakePipeline_Call struct {
	*mock.Call
}

// MakePipeline is a helper method to define mock.On call
func (_e *Application_Expecter) MakePipeline() *Application_MakePipeline_Call {
	return &Application_MakePipeline_Call{Call: _e.mock.On("MakePipeline")}
}

func (_c *Application_MakePipeline_Call) Run(run func()) *Application_MakePipeline_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Application_MakePipeline_Call) Return(_a0 pipeline.Pipeline) *Application_MakePipeline_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Application_MakePipeline_Call) RunAndReturn(run func() pipeline.Pipeline) *Application_MakePipeline_Call {
	_c.Call.Return(run)
	return _c
}
